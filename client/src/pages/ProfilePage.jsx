...
const ProfilePage = () => {
  ...
  return (
    <div className='min-h-screen bg-cover bg-no-repeat flex items-center text-white justify-center'>
      <div className='w-5/6 max-w-2xl backdrop-blur-2xl test-gray-300 border-2 border-gray-600 flex
