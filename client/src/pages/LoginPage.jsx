...
const LoginPage = () => {
  ...
  return (
    ...
    max-sm:flex-col backdrop-blur-2xl'>
      ...
      {/* lets create left side first */}
      <img src={assets.logo_big} alt="" className='w-[min(30vw,250px)]' />
      

      {/* yha se hum right side create krenge */}
      ...
      rounded-lg shadow-lg'>
        ...
        {!isDataSubmitted && (
          <>
          <input onChange={(e)=>setEmail(e.target.value)} value={email} type="email" placeholder='Your Email' required className='p-2 border border-gray-500
        ...
        {currState === "Sign up" && isDataSubmitted &&(
          ...
          placeholder='Enter a short note about you....' required></textarea>
         )
        }
        ...
        <div className='flex items-center gap-2 text-sm text-gray-500'>
          <input type="checkbox" />
          <p>Agree to terms of use & privacy policy of Chattrix</p>
        </div>
