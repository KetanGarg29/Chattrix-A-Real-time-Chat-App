...
const ChatContainer = () => {
  ...
  return selectedUser ? (
    <div className='w-full overflow-scroll relative backdrop-blur-lg'>
      ...
      <div className='absolute bottom-0 left-0 right-0 flex items-center gap-3 p-3'>
        <div className=' flex-1 flex items-center bg-gray-100/12 px-3 rounded-full'>
          ...
          type="text" placeholder='Send Message'className='flex-1 text-sm p-3 border-none rounded-lg 
    ...
    <div className='flex flex-col items-center justify-center gap-2 text-gray-500 bg-white/10 max-md:hidden'>
      ...
      <p className='text-lg font-medium text-white'>Chattrix!! Chat Anytime, Anywhere</p>
    </div>
  )
}
